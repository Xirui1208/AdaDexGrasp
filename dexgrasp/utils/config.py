...
def load_cfg(args, use_rlg_config=False):
    ...
    if args.num_finger_contact > 0:
        cfg["env"]["num_finger_contact"] = args.num_finger_contact
...
def get_args(benchmark=False, use_rlg_config=False):
    custom_parameters = [
        ...
        {
            "name": "--num_finger_contact", "type": int, "default": 0,
            "help": "Number of finger contacts to trigger data collection"
        },
