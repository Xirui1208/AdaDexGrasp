...
class ShadowHandRandomLoadVision(BaseTask,TacSLTaskImageAugmentation,TacSLSensors):
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless,
        ...
        self.segmentation_id = {
            ...
            'goal': 4,
            'table': 1,
            'contact': 5  #no use in latest version
        }
        ...
        self.cmap_threshold = 0.99
        self.tactile_distance_threshold = 8e-3 
        ...
        self.global_dist_threshold = 5e-3
        if self.viewer != None:
        ...
        self.save_data_path = os.path.join(self.save_data_dir, "airplane-fail.npz")
            ...
            for env_id in env_ids:
                if self.data_collected_buf[env_id]:
                    ...
                    if should_collect:
                        ...
                        object_pose_data = self.temp_object_state_buf[env_id]
