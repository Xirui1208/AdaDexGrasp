...
sys.path.append("/media/isaac/cf0a748c-87f5-4f21-b341-3a660e53cd74/home/user/xirui/grasp_new/grasp-tactile/Diffusion_Policy_3D")
...
class TrainDP3Workspace:
    ...
    def get_policy_and_runner(self, cfg, ckpt_path):
        ...
        #         f"Diffusion_Policy_3D/checkpoints/{task_name}/{checkpoint_num}.ckpt"
        #     )
        # else:
        #     ckpt_file = pathlib.Path(
        #         f"Diffusion_Policy_3D/checkpoints/{task_name}_w_rgb/{checkpoint_num}.ckpt"
        #     )
